        ...
        <CardContent>
          <Tabs defaultValue="signin" className="w-full">
            <TabsList className="grid w-full grid-cols-2 bg-purple-100 p-1 rounded-xl">
              <TabsTrigger 
                value="signin" 
                className="data-[state=active]:bg-white data-[state=active]:text-purple-700 data-[state=active]:shadow-md rounded-lg px-3 py-2 text-sm font-medium text-purple-600 transition-all duration-200"
              >
                Sign In
              </TabsTrigger>
              <TabsTrigger 
